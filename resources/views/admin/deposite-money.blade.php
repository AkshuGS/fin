                  ...
                  <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Vendor name
                                <a href="/vendors-details/id"> <button class="btn ">Details</button></a>
                            </h6>
                                ...
                                <div class="col-lg-8">
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            ...
                                            <a href="" class="btn btn-success btn-user ">
                                                Save
                                            </a>
